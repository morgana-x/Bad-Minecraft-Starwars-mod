 ...
 */
public class StormTrooperEntity extends HumanEntity {

    public StormTrooperEntity(EntityType<? extends HumanEntity> entityType, World world) {
    ...
    protected void initEquipment(Random random, LocalDifficulty localDifficulty) {
        ...
        this.equipStack(EquipmentSlot.CHEST, new ItemStack((RegisterItems.STORMTROOPER_CHESTPLATE)));
        this.equipStack(EquipmentSlot.HEAD, new ItemStack((RegisterItems.STORMTROOPER_HELMET)));
        this.equipStack(EquipmentSlot.LEGS, new ItemStack((RegisterItems.STORMTROOPER_LEGGINGS)));
        this.equipStack(EquipmentSlot.FEET, new ItemStack((RegisterItems.STORMTROOPER_BOOTS)));
    }
    ...
    {
        this.targetSelector.add(2, new ActiveTargetGoal(this, RebelTrooperEntity.class, true));
